      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>page admin</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> creat new tour<span class="fa fa-chevron-down"></span></a>
                  </li>
                  <li><a><i class="fa fa-edit"></i> List tour <span class="fa fa-chevron-down"></span></a>
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <li role="presentation" class="dropdown">
                  ...
                  <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                    ...
                    <li>
                      <a>
                        <span class="image"><img src="hentelalla/production/images/img.jpg" alt="Profile Image" /></span>
                        <span>
        ...
        <footer>
          <div class="pull-right">
            Page admin Top Team <a href="https://colorlib.com">"Luong Thao"</a>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
